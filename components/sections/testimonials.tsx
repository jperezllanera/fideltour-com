...
const items = [
  {
    ...
    image: "/brand/caso-gf-costa-adeje.jpg",
  },
  {
    quote:
    ...
    image: "/brand/caso-universal-aquamarin.jpg",
  },
  {
    quote:
    ...
    org: "Ohtels",
    image: "/brand/caso-ohtels-gran-almeria.jpg",
  },
];
          ...
          {items.map((t) => (
            ...
            >
              <div className="relative aspect-[4/3] w-full overflow-hidden">
                ...
                <div className="absolute bottom-3 left-4 right-4 font-mono text-[11px] uppercase tracking-wider text-white">
                  {t.org}
                </div>
              </div>
              <CardContent className="flex h-full flex-col gap-5 p-6">
                <div
                  aria-hidden
                  className="font-mono text-2xl leading-none text-brand"
                >
                  &ldquo;
                </div>
