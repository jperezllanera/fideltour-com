...
export function AuditoriaHeroSection() {
  return (
    <section className="relative overflow-hidden bg-hero-gradient text-white isolate">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-[18%] top-1/2 -translate-y-1/2 size-[144vw] max-w-[1320px] max-h-[1320px] rounded-full border-[160px] border-brand/[0.22]"
      />
