...
export function PortalCautivoCtaSection() {
  return (
        ...
        <div className="relative overflow-hidden rounded-3xl bg-hero-gradient p-8 text-white shadow-[var(--shadow-bento)] md:p-16">
          ...
          <div className="relative flex flex-col items-start gap-6 md:max-w-3xl">
            ...
            <h2 className="h-cta text-white">
              Convierte cada acceso WiFi en{" "}
              <span className="text-brand">venta directa</span>.
            </h2>
            <p className="max-w-2xl text-base leading-relaxed text-white/80 md:text-lg">
              Integra tu portal cautivo con Fideltour y transforma el servicio
              de WiFi en un canal de captación y marketing.
            </p>
