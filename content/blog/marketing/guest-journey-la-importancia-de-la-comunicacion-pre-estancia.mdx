...
La principal oportunidad de ingresos ocurre entre la reserva y la llegada. Sorprendentemente, el **98% de los ingresos** por [upselling](/blog/marketing/claves-upselling-y-cross-selling-efectivo-hoteles/) vía email se generan antes del _check-in_. Una [secuencia de automatización](/blog/marketing/automatizacion-email-marketing-mejorar-guest-journey/) efectiva debe seguir **tres hitos clave**:
